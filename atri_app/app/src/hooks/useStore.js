...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image31": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/classic%20shake.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image34": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/chicken%20burg.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox129": {
      "custom": {
        "text": "Note: I have  used Carousel here, which for some reason, is not able to size itself, nor it is able to  screen any image in its publish"
      },
      "callbacks": {
        "onClick": [
          {
